...
public class ThunderPkmn extends Pokemon {
    /**
     * Constructor de la clase ThunderPkmn
     ...
     */
    ThunderPkmn(String str, int hp, int id, ArrayList<Ataque> atks){
        this.name= str;
    ...
    public void attack(Ataque ataque, Pokemon pkmn) {
        pkmn.recieveThunderAttack(ataque);
    }
    /**
